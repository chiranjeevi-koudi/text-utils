      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className={`form-check form-switch ${props.mode ==='light'? 'dark':'light'}`}>
            <input onClick={props.toggleMode} className="form-check-input" type="checkbox" role="switch" id="mode" />
            <label className="form-check-label" htmlFor="mode">Enable {props.mode === 'light'?'dark':"light"} mode</label>
          </div>
        </div>
      </div>
